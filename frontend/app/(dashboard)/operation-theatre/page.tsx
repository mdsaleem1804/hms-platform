  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Operation Theatre</h1>
          <p className="mt-2 text-gray-600">Manage surgical procedures and operation scheduling</p>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="mt-2 text-sm text-yellow-700">
                Operation theatre management including surgical scheduling, procedure tracking, and
                surgical records will be available soon.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {['Surgical Schedules', 'Surgical Procedures', 'Theatre Bookings', 'Surgical Reports'].map((item) => (
