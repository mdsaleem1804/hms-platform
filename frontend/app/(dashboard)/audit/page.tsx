    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Track system activities and audit logs</p>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="mt-2 text-sm text-yellow-700">
                Audit and logging features including activity tracking, user actions, and system event
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {['Activity Logs', 'User Actions', 'System Events', 'Audit Reports'].map((item) => (
