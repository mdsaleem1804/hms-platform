    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Manage hospital supplies, equipment, and assets</p>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="mt-2 text-sm text-yellow-700">
                Inventory management features including stock tracking, equipment management, and
                procurement will be available soon.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {['Stock Management', 'Equipment Tracking', 'Procurement', 'Supplier Management'].map((item) => (
