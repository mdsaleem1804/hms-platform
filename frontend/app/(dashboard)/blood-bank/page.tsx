    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Manage blood inventory and transfusion services</p>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="mt-2 text-sm text-yellow-700">
                Blood bank management features including inventory tracking, donor management, and
                transfusion requests will be available soon.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {['Blood Inventory', 'Donor Management', 'Transfusion Requests', 'Tests & Screening'].map((item) => (
