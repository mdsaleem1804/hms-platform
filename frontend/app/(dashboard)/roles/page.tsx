    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="mt-2 text-sm text-yellow-700">
                Role and permission management features including custom role creation and permission
        ...
        <div className="rounded-lg bg-white p-12 text-center shadow">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">No roles created yet</h3>
          <p className="mt-2 text-sm text-gray-600">Create a new role to get started</p>
        </div>
      </div>
    </div>
  );
