    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Generate and analyze hospital reports and statistics</p>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="mt-2 text-sm text-yellow-700">
                Advanced reporting and analytics features including financial statements, patient
                statistics, and performance metrics will be available soon.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {['Financial Reports', 'Patient Statistics', 'Department Performance', 'Doctor Performance'].map((item) => (
