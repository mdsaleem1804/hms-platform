    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Manage hospital staff and employee information</p>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="mt-2 text-sm text-yellow-700">
                Staff management features including employee profiles, attendance tracking, and payroll
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {['Staff Profiles', 'Attendance Tracking', 'Leave Management', 'Payroll Management'].map((item) => (
